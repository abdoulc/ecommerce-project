...
public class CreatePaymentUseCaseImpl implements CreatePaymentUseCase {
    ...
    public CreatePaymentUseCaseImpl(IdempotencyPort idempotencyPort, OrderRepository orderRepository, PaymentRepository paymentRepository) {
    ...
    private PaymentResponseDTO createPaymentIntent(CreatePaymentInput createPaymentInput) {
        ...
        //PaymentIntent intent = stripeClient.createIntent(order);
